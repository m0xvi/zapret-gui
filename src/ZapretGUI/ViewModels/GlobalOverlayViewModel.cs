...
public sealed class GlobalOverlayViewModel : ObservableObject
{
    ...
    public bool OverlayVisible => IsVisible && !IsMinimized;
    public bool MinimizedVisible => IsVisible && IsMinimized;
